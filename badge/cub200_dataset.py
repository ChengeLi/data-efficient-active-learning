...
class Cub200(Dataset):
    ...
    def __init__(self, root, train=True, transform=None, center_crop=True, crop=1.2, target_size=(32, 32)):
        """
            Load the dataset.
            Input:
        ...
        self._crop = crop
        self.data_train = data[data.is_training_img == 1]
        self.data_test = data[data.is_training_img == 0]
